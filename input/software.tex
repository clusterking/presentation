...
\begin{frame}{Software}
   ...
   {\raisebox{0.45cm}{\scalebox{1.3}{\color[gray]{0.4}\texttt{https://github.com/}}}\hspace{0.1cm}{\includegraphics[height=2cm]{figures/software_logos/clusterking.pdf}}}
    ...
    \begin{columns}
	    ...
	    \begin{itemize}
	        ...
	        \item \vcenteredinclude{\includegraphics[height=4ex]{figures/software_logos/sklearn_small.pdf}} \texttt{scikit-learn} {\footnotesize(clustering tools)}
...
\begin{frame}{Software}
    \begin{itemize}
        \item Up to date \stress{documentation} on \vcenteredinclude{\includegraphics[height=2.5ex]{figures/software_logos/rtd_noname.pdf}} \texttt{Read the Docs}:\\[3ex]
...
\begin{frame}{Software}
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item \stress{Add errors} (optional): Easy interface to add various kinds of errors\\
